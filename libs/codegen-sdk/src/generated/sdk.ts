...
export type GetUsersBackendQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUsersBackendQuery = { __typename?: 'query_root', users: Array<{ __typename?: 'users', id: any, display_name?: string | null, account?: { __typename?: 'auth_accounts', email?: any | null } | null }> };


export const GetUsersBackendDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getUsersBackend"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"users"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"display_name"}},{"kind":"Field","name":{"kind":"Name","value":"account"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"email"}}]}}]}}]}}]} as unknown as DocumentNode;
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getUsersBackend(variables?: GetUsersBackendQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetUsersBackendQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetUsersBackendQuery>(GetUsersBackendDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getUsersBackend');
    }
  };
}
